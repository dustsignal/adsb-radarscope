...
// This file contains most user-configurable settings and constants
...
const CONFIG = {
    ...
    DEFAULT_TAR1090_URL: 'http://[datasource]/aircraft.json',
    ...
    // Trail Settings
    MAX_TRAIL_LENGTH: 60,
    TRAIL_FADE_TIME_MINUTES: 2,
    TRAIL_GRADIENT_SEGMENTS: 40,
    SMOOTHING_FACTOR: 5.3,
